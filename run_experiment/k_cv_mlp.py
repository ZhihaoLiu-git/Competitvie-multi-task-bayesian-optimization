...
class GetCmtData:
    ...
    def get_task_output(self, task_index=None, x=None):
        ...
        clf = MLPClassifier(activation='relu', max_iter=2000,
                            alpha=x[0], hidden_layer_sizes=[int(x[1]), int(x[2])])
...
trials = 30
budget = 50
data_name = 'glass'  #['generate_classification', 'breast_cancer', 'wine', 'digits', 'iris', 'eeg_eye_state', 'glass']
save_flag = False
save_flag2 = False
